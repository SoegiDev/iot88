...
from controller.AdminController import c_register_device_admin,c_login_admin,c_register_admin,c_change_password_admin,c_change_device_admin,c_get_device_admin,c_change_device_sensor_admin
from controller.UserController import c_register,c_login,c_change_password,c_register_device,c_change_device,c_change_device_sensor,c_get_device
...
def create_change_device_sensor_admin():
    ...
    device = {"id":y['id']}
    sensor = {}
    sensor = {"name":y['name'],"description":y['description'],"active":y['active'],"threshold":y['threshold']}
